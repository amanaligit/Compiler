...
#define PRE_COMPUTING_MULTIPLE_COUNT 12

typedef struct entry{
    char* str; //the string corresponding to the lexeme
    int val; //the value for the lexeme
...
long long hashMultiples[PRE_COMPUTING_MULTIPLE_COUNT];
...
int pushHashTable(char* str, Tk tokenType, hashEntry hashTable[]);
